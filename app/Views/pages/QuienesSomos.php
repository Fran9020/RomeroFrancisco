...
<section class="container-fluid main-section">
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-5 custom-card me-md-3 mb-4 mb-md-0" style="padding-bottom: 20px; height: 250px; padding-top: 30px;">
                <div class="rounded-circle overflow-hidden" style="width: 150px; height: 150px; margin: 0 auto;">
                    <img src="http://localhost/RomeroFrancisco/public/assets/img/fotoperfilfran.png" class="img-fluid w-100 h-100 object-fit-cover" alt="Romero Francisco Ignacio">
                </div>
            ...
            <div class="col-md-5 custom-card" style="padding-bottom: 20px; height: 250px; padding-top: 30px;">
                <div class="rounded-circle overflow-hidden" style="width: 150px; height: 150px; margin: 0 auto;">
                    <img src="https://via.placeholder.com/500x250?text=Imagen+2" class="img-fluid w-100 h-100 object-fit-cover" alt="Sosa Diana">
                </div>
                <div class="card-body-custom text-center">
                    <h5 class="card-title-custom">Sosa Diana</h5>
                </div>
            </div>
        </div>
    </div>
