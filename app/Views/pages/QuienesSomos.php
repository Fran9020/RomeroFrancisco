...
<section class="container-fluid main-section">
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            <!-- Espacio 1 -->
            <div class="col-md-5 custom-card me-md-3 mb-4 mb-md-0">
                <img src="https://via.placeholder.com/500x250?text=Imagen+1" class="img-fluid w-100 card-image" alt="Imagen 1">
            ...
            <div class="col-md-5 custom-card">
                <img src="https://via.placeholder.com/500x250?text=Imagen+2" class="img-fluid w-100 card-image" alt="Imagen 2">
                <div class="card-body-custom">
