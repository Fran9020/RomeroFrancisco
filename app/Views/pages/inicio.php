...
<<<<<<< HEAD
    ...
    <img src="http://localhost/RomeroFrancisco/public/assets/img/TituloFondo.png" alt="Logo Game-Box" class="title-image img-fluid">
</section>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="d-flex flex-column flex-md-row align-items-center">
                                                ...
                                                <div class="ms-md-3 text-start mt-3 mt-md-0">
                                                    <h4>Dark Souls</h4>
...
<<<<<<< HEAD
                            <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                                <div class="row mb-2 w-100">
                                    <div class="col-6">
                                        <img src="http://localhost/RomeroFrancisco/public/assets/img/imagen1.jpg" class="img-thumbnail clickable-thumbnail thumbnail-image img-fluid" data-bs-target="#imageCarousel" data-bs-slide-to="0" alt="Miniatura 1">
                                    </div>
                                    <div class="col-6">
                                        <img src="http://localhost/RomeroFrancisco/public/assets/img/imagen2.jpg" class="img-thumbnail clickable-thumbnail thumbnail-image img-fluid" data-bs-target="#imageCarousel" data-bs-slide-to="1" alt="Miniatura 2">
                                    </div>
                                </div>
                                <div class="row w-100">
                                    <div class="col-6">
                                        <img src="http://localhost/RomeroFrancisco/public/assets/img/imagen3.jpg" class="img-thumbnail clickable-thumbnail thumbnail-image img-fluid" data-bs-target="#imageCarousel" data-bs-slide-to="2" alt="Miniatura 3">
                                    </div>
                                    <div class="col-6">
                                        <img src="http://localhost/RomeroFrancisco/public/assets/img/imagen4.jpg" class="img-thumbnail clickable-thumbnail thumbnail-image img-fluid" data-bs-target="#imageCarousel" data-bs-slide-to="3" alt="Miniatura 4">
=======
                            <!-- Miniaturas 2x2 -->
                            <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                                <div class="row mb-2">
                    ...
                    <li class="mb-3">
                        ...
                        <div class="d-flex flex-wrap">
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/imagen1.jpg" class="img-fluid mb-2 section-image" alt="Oferta 1" style="max-height: 150px;">
                                <h6 class="mt-1 section-title">Dark Souls</h6>
                                <p class="section-price price-text">$29.99</p>
                            </div>
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/spidermnan.jpg" class="img-fluid mb-2 section-image" alt="Oferta 2" style="max-height: 150px;">
                                <h6 class="mt-1 section-title">Spider-man</h6>
                                <p class="section-price price-text">$29.99</p>
                            </div>
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/No-More-Heroes.jpg" class="img-fluid mb-2 section-image" alt="Oferta 3" style="max-height: 150px;">
...
<<<<<<< HEAD
                        <div class="d-flex flex-wrap">
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/monsterhunter.jpg" class="img-fluid mb-2 section-image" alt="Mejor Calificado 1" style="max-height: 150px;">
                                <h6 class="mt-1 section-title">Monster Hunter</h6>
                                <p class="section-price price-text">$29.99</p>
                            </div>
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/mario.jpg" class="img-fluid mb-2 section-image" alt="Mejor Calificado 2" style="max-height: 150px;">
                                <h6 class="mt-1 section-title">Mario Kart 8</h6>
                                <p class="section-price price-text">$24.99</p>
                            </div>
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/imagen2.jpg" class="img-fluid mb-2 section-image" alt="Mejor Calificado 3" style="max-height: 150px;">
...
<<<<<<< HEAD
                        <div class="d-flex flex-wrap">
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/black.jpg" class="img-fluid mb-2 section-image" alt="Clásico 1" style="max-height: 150px;">
                                <h6 class="mt-1 section-title">Black</h6>
                                <p class="section-price price-text">$19.99</p>
                            </div>
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/godofwar.jpg" class="img-fluid mb-2 section-image" alt="Clásico 2" style="max-height: 150px;">
                                <h6 class="mt-1 section-title">God Of War</h6>
                                <p class="section-price price-text">$39.99</p>
                            </div>
                            <div class="text-center mb-3" style="width: 33.33%;">
                                <img src="http://localhost/RomeroFrancisco/public/assets/img/Doom-64.jpg" class="img-fluid mb-2 section-image" alt="Clásico 3" style="max-height: 150px;">
