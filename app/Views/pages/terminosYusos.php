        ...
        <div class="col-md-7 p-4 border rounded bg-light text-dark" style="margin-top: -50px;"> <!-- Ajusté el margin-top a -20px para subir el cuadro -->
            ...
            <div class="mb-4">
                ...
                <p>
                    ...
                    estos términos en cualquier momento para garantizar la actualización
                    y mejora de nuestros servicios. El uso del sitio constituye tu aceptación 
                    de las modificaciones que vayan a realizarse en el futuro.
                </p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p>
                    ...
                    que sin excepción puedan recibir los servicios que se mencionan a continuación:
                    Gestión de Pedidos, Soporte al Cliente y Acceso a Promociones Exclusivas.
                </p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p>
                    ...
                    únicamente para mejorar la experiencia de uso en el sitio y no será compartida con ningún otro
                    organismo profesional, a no ser que el mismo usuario lo autorice, siempre en cumplimiento con las 
                    normativas legales vigentes. La información obtenida de los usuarios empezará a ser empleada
                    desde el momento en que estos creen un usuario correspondiente al sitio en cuestión.
                </p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p>
                    ...
                    seguros, garantía de calidad y soporte postventa. Además, se
                    incluyen formas de entrega diseñadas para adaptarse a las necesidades
                    de cada usuario, con tiempos de envío claros y opciones flexibles.
                </p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p>
                    ...
                    en la realización de devoluciones, reparaciones o cualquier otro cambio que se desee realizar
