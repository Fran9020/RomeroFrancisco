    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 p-4 border rounded bg-light text-dark">
                <h2 class="display-5 text-center mb-4">Información de Contacto</h2>

                <!-- Espacio 1: Contacto de Persona 1 -->
                <div class="card mb-4">
                    <div class="card-body">
                        <h4 class="card-title">Contacto: Romero Francisco Ignacio</h4>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h4 class="card-title">Contacto: Diana Sosa</h4>
